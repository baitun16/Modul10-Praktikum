...
class AddEditNoteActivity : AppCompatActivity() {
    companion object {
        const val EXTRA_ID = "com.example.praktikummodul10.EXTRA_ID"
        const val EXTRA_JUDUL = "com.example.praktikummodul10.EXTRA_JUDUL"
        const val EXTRA_DESKRIPSI = "com.example.praktikummodul10.EXTRA_DESKRIPSI"
        const val EXTRA_PRIORITAS = "com.example.praktikummodul10.EXTRA_PRIORITAS"
